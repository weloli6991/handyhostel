    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('save-clients') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="phone" class="phone form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="(12) 34567-8910" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth-date" type="birth-date" class="date form-control @error('birth-date') is-invalid @enderror" name="birth-date" placeholder="12-12-2012" required autocomplete="new-birth-date">
